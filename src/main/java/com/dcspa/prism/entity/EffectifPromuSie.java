...
@AutoCode(field = "codeEffectifPromuSie")
...
public class EffectifPromuSie {
    ...
    @Column(name = "EFFECTIF_PROMU_SIE_4_6_NON_IVOIRIIEN_F")
    private Integer effectifPromuSie46NonIvoiriienF;
    ...
    @Column(name = "EFFECTIF_PROMU_SIE_NIVEAU_H")
    private Integer effectifPromuSieNiveauH;

    @Column(name = "EFFECTIF_PROMU_SIE_NIVEAU_F")
    private Integer effectifPromuSieNiveauF;
