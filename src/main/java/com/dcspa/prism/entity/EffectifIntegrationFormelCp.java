...
public class EffectifIntegrationFormelCp {
    ...
    @Column(name = "EFFECTIF_INT_FORMEL_CP_NIVEAU_H")
    private Integer effectifIntegrationFormelCpNiveauH;

    @Column(name = "EFFECTIF_INT_FORMEL_CP_NIVEAU_F")
    private Integer effectifIntegrationFormelCpNiveauF;
