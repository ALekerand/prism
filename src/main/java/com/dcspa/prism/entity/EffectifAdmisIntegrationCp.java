...
@AutoCode(field = "codeEffectifAdmisIntegrationCp")
...
public class EffectifAdmisIntegrationCp {
    ...
    @Column(name = "EFFECTIF_ADMIS_INTEGRATION_CP_12_13_NON_IVOIRIIEN_F")
    private Integer effectifAdmisIntegrationCp1213NonIvoiriienF;
